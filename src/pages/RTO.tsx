...
export default function RTO() {
  ...
  const loadRTOReservations = useCallback(
    async (tab: TabType) => {
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              Created: {reservation.created_at ? new Date(reservation.created_at).toLocaleDateString() : "Unknown date"}
            </span>
          </div>
      ...
      <div className="p-4 max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Return to Origin (RTO)</h1>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs text-blue-800 space-y-1">
          ...
          {apiResponse && Array.isArray(apiResponse) && <p>API Response Array Length: {apiResponse.length}</p>}
        </div>
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="pending" className="space-y-6">
            ...
            {!currentLocationId ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">{currentItems.map(renderReservationCard)}</div>
            )}
          </TabsContent>
              ...
              <div className="text-center py-20">
                ...
                {completedReservations.length > 0 && (
                  <p className="text-sm text-orange-600 mt-2">
                    Note: There are {completedReservations.length} completed reservations but they don't match your
                    search.
                  </p>
                )}
              </div>
